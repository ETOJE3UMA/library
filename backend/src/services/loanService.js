...
const SettingsServise = require('../services/settingsService');
...
module.exports = class LoanService {
  ...
  async update(id, data) {
    ...
    if (!data.returnDate) {
      throw new ValidationError (
        this.language,
        'entities.loan.validation.returnDateRequred',
      );
    }
  ...
  async _calculateDueDate(data){
    const settings = await SettingsServise.findOrCreateDefault(
      this.currentUser,
    );
