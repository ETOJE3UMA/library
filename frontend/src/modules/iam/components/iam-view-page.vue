  ...
  <div>
    ...
    <div class="app-content-page">
      ...
      >
        ...
        <app-view-item-text :label="fields.school.label" :value="presenter(record, 'school')"></app-view-item-text>
        <app-view-item-text :label="fields.classSchool.label" :value="presenter(record, 'classSchool')"></app-view-item-text>
        <app-view-item-text
