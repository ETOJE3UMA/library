    ...
    <div class="app-content-page">
      ...
      >
        ...
        <el-form-item
          ...
          :prop="fields.school.name"
          :required="fields.school.required"
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-input v-model="model[fields.school.name]"/>
          </el-col>
        </el-form-item>

        <el-form-item
          :label="fields.classSchool.label"
          :prop="fields.classSchool.name"
          :required="fields.classSchool.required"
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-input v-model="model[fields.classSchool.name]"/>
          </el-col>
        </el-form-item>
