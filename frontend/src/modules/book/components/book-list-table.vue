      ...
      >
        ...
        >
          <template slot-scope="scope">
            <app-list-item-image
              class="book-image-list-item"
              :value="presenter(scope.row, 'images')"
            ></app-list-item-image>
          </template>
        </el-table-column>
